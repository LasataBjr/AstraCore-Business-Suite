    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-5">
        ...
        <div class="xl:col-span-2 space-y-5">
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-6">
                ...
                {{-- Toolbar hint (attach TinyMCE / Trix / Quill) --}}
                <div class="mb-2 flex flex-wrap gap-1.5">
                    ...
                    @endforeach
                    <span class="self-center text-[10px] text-slate-400 ml-1">— Attach a rich-text editor to #description</span>
                </div>
                ...
                <textarea
                    ...
                    name="description"
                    rows="14"
                    placeholder="Write a detailed description of this service — what it includes, who it's for, and what clients can expect…"
                    class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-800 placeholder-slate-400
                        focus:border-indigo-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-100 transition resize-y
